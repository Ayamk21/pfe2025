...
const Chatroom = () => {
        ...
        const fetchConversationAndMessages = async () => {
            ...
            try {
                ...
                if (conv) {
                    ...
                    await axios.put(`http://localhost:5000/message/markAsRead/${conv._id}`, {
    ...
    useEffect(() => {
        socket.on('receiveMessage', (data) => {
            ...
            if (data.sender !== currentUser._id) {
                ...
                receivedAudioRef.current.play().catch(e => console.error("Audio error:", e));
            }
        });
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            sentAudioRef.current.play().catch(e => console.error("Audio error:", e));
