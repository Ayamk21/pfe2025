...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Erreur!",
        text: error?.response?.data?.msg || "Une erreur s'est produite lors de l'inscription.",
        icon: "error"
      });
    }
  };
  ...
  return (
    <div className="isolate bg-gradient-to-tr from-blue-100 to-transparent px-6 py-16 sm:py-20 lg:px-8">
      <form className="w-11/12 md:w-3/4 lg:w-2/3 xl:w-1/2 mx-auto p-8 md:p-12 bg-white shadow-xl rounded-2xl border border-gray-200" onSubmit={handleSubmit}>
        <div className="space-y-8">
          {/* Section d'introduction */}
          <div className="border-b border-gray-900/10 pb-8">
            <h2 className="text-3xl font-bold text-indigo-700">Devenir membre</h2>
          ...
          <div className="border-b border-gray-900/10 pb-8">
            ...
            <div className="mt-8 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-1 relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <IdentificationIcon className="size-5 text-gray-400" aria-hidden="true" />
                  </div>
                  <input
                    id="cin"
                    name="cin"
                ...
                <>
                  <div className="sm:col-span-4 grid grid-cols-1 gap-y-6">
                    ...
                    <div className="col-span-full">
                      <label htmlFor="gouvernorat" className="block text-sm font-medium text-gray-900">
                        Gouvernorat
                      </label>
                      <div className="mt-1 relative">
                        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    ...
                    {/* Institut */}
                    <div className="col-span-full">
                      <label htmlFor="institut" className="block text-sm font-medium text-gray-900">
                        Institut
                      </label>
                      <div className="mt-1 relative">
                        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                          <BuildingOffice2Icon className="size-5 text-gray-400" aria-hidden="true" />
                        </div>
                        <select
                          id="institut"
                          name="institut"
                        ...
                        >
                          ...
                          <option value="Institut supérieur des etudes juridiques">Institut supérieur des études juridiques</option>
                          <option value="Faculté des sciences">Faculté des sciences</option>
                          <option value="Ecole nationale d'ingenieurs">École nationale d'ingénieurs</option>
                        </select>
                        <ChevronDownIcon
                          aria-hidden="true"
                          className="pointer-events-none absolute inset-y-0 right-0 mr-2 size-5 self-center text-gray-500 sm:size-4"
                    ...
                    {/* Niveau d'études */}
                    <div className="col-span-full">
                      <label htmlFor="niveau" className="block text-sm font-medium text-gray-900">
                        Niveau d'études
                      </label>
                      <div className="mt-1 relative">
                        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                          <AcademicCapIcon className="size-5 text-gray-400" aria-hidden="true" />
                        </div>
                        <select
                          id="niveau"
                          name="niveau"
                    ...
                    <div className="col-span-full">
                      ...
                      <div className="mt-1 relative">
                        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                          <CakeIcon className="size-5 text-gray-400" aria-hidden="true" />
                        </div>
                        <input
                          id="age"
                          name="age"
                  ...
                  <div className="sm:col-span-2 flex flex-col items-center justify-center pt-6">
                    <label htmlFor="cover-photo" className="block text-sm font-medium text-gray-900 mb-1">
                      Photo de profil
                    </label>
                    <div className="flex justify-center rounded-lg border-2 border-dashed border-indigo-300 bg-indigo-50 px-4 py-8 hover:border-indigo-500 hover:bg-indigo-100 transition-colors duration-200 w-full text-center">
                      <div className="text-center">
                        <PhotoIcon aria-hidden="true" className="mx-auto size-14 text-indigo-400" />
                        <div className="mt-3 flex text-sm text-gray-600">
                          ...
                          >
                            ...
                            <input id="file-upload" name="photo" type="file" accept="image/*" className="sr-only" onChange={(e) => setnewuser({ ...newuser, photo: e.target.files[0] })} />
                          </label>
                          <p className="pl-1">ou glissez-déposez</p>
                        </div>
                        <p className="text-xs text-gray-600">PNG, JPG, JPEG jusqu'à 10MB</p>
                        {newuser.photo && (
                          <p className="mt-2 text-sm text-indigo-600">Fichier sélectionné : {newuser.photo.name}</p>
                        )}
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-span-full">
                ...
                <div className="mt-1 relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <LockClosedIcon className="size-5 text-gray-400" aria-hidden="true" />
                  </div>
                  <input
                    id="password"
                    name="password"
        ...
        {newuser.role === "etudiant" && (
          <div className="col-span-full mt-6">
            ...
            <div className="mt-1 relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <UserCircleIcon className="size-5 text-gray-400" aria-hidden="true" />
              </div>
              <textarea
                id="about"
                name="about"
            ...
            <p className="mt-2 text-sm text-gray-600">Écrivez quelques phrases sur vous.</p>
          </div>
        )}
